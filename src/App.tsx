...
function App() {
    ...
    const goodsInBasket = goods.filter(el=>el.inCart)
    ...
    return (
        <div className="App">
            <VideoBackground />
            <Wrapper>
                <Header setModal={setModal} goodsInBasket={goodsInBasket}/>
                {modal && <Basket setModal={setModal} goodsInBasket={goodsInBasket} changeGoodsStatus={changeGoodsStatus}/>}
